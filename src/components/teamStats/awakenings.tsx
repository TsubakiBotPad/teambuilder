...
export async function computeTotalAwakeningsFromSlots(
  slots: TeamSlotState[],
  includeSA: boolean,
  hasAssists: boolean,
  badgeId: string
...
export async function computeTotalAwakenings(
  ...
  return computeTotalAwakeningsFromSlots(slots, gameConfig.mode !== "2p", hasAssists, teamState[playerId].badgeId);
}
