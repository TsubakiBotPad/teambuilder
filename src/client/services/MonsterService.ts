...
export class MonsterService {
   ...
   * @throws ApiError
   */
  public static getManyById(q?: string): CancelablePromise<MonstersResponse> {
    return __request(OpenAPI, {
      method: "GET",
   ...
   * @throws ApiError
   */
  public static teamBuilderQuery(q?: string): CancelablePromise<MonsterWithEvosResponse> {
    return __request(OpenAPI, {
      method: "GET",
