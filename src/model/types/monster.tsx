...
export const typeToKillers: { [key in MonsterType]: string[] } = {
  ...
  [MonsterType.Balanced]: ["God", "Devil", "Dragon", "Machine", "Balanced", "Healer", "Attacker", "Physical"],
  [MonsterType.Awoken]: [],
  [MonsterType.Enhance]: [],
  [MonsterType.Evolve]: [],
  [MonsterType.Vendor]: []
